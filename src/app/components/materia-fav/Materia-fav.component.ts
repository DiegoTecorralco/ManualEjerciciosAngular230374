...
export class MateriaFavComponent implements OnInit {
  ...
  datos = [
    ...
    { id: 230496, nombre: 'Cabrera Velazquez Edgar', Materia: 'APWI4.0' },
    ...
    { id: 230315, nombre: 'Fosado Escudero Carlos Isac', Materia: 'APWI4.0' },
    { id: 230598, nombre: 'Galindo Gonzales Lorena Citlalli', Materia: 'APWI4.0' },
    ...
    { id: 230369, nombre: 'Ibarra Salgado Tania', Materia: 'Desarrollo Web' },
    { id: 230365, nombre: 'Jimenez Castillo Jose Agustin', Materia: 'Base de datos' },
    { id: 230353, nombre: 'Brandon Leon Cabrera', Materia: 'APWI4.0' },
    { id: 230415, nombre: 'Lopez Neri Ana Daniela', Materia: 'Base de datos' },
    { id: 230166, nombre: 'Martinez Otero Josue Atlai', Materia: 'Desarrollo Web' },
    { id: 230768, nombre: 'Medina Torres Uriel Abdalah', Materia: 'Base de datos' },
    { id: 230308, nombre: 'Mendoza Marquez Brian Jesus', Materia: 'APWI4.0' },
    { id: 230570, nombre: 'Negrete Hernandez Karen Lizbeth', Materia: 'Base de datos' },
    { id: 230642, nombre: 'Ocpaco Dolores Antonio', Materia: 'Desarrollo Web' },
    { id: 230410, nombre: 'Ramirez Reyes Jonathan Baldemar', Materia: 'APWI4.0' },
    { id: 230733, nombre: 'Rios Duran Marcos Jesus', Materia: 'APWI4.0' },
    { id: 230809, nombre: 'Rodriguez Peres Christian Paul', Materia: 'Base de datos' },
    { id: 230190, nombre: 'Romero Martinez Yared Amaury', Materia: 'APWI4.0' },
    { id: 230499, nombre: 'Rufino Mendoza Angel De Jesus', Materia: 'Base de datos' },
    { id: 230374, nombre: 'Tecorralco Martinez Diego Salvador', Materia: 'APWI4.0' },
