...
export class SidebarComponent implements OnInit {
  ...
  menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      expanded: false,
      children: [
        { text: 'Materia Favorito', icon: 'Materia Favorita', route: '/materia', description: 'Tabla donde se muestran las materias favoritas del grupo 5B', showDescription: false, extraDetails: 'Materias favoritas de cada uno de mis compañeros en tablas que contengan paginacion', showUnitName: false, showExerciseName: false, unitName: 'Unidad 2', exerciseName: 'Tabla de Materia Favorita' },
        { text: 'Enfermedades del corazon', icon: 'Enfermedades del corazon', route: '/enfermedades', description: 'Tabla donde se muestran las enfermedades del corazon', showDescription: false, extraDetails: 'Tabla de la bd Heart Disease en tablas que contengan paginacion', showUnitName: false, showExerciseName: false, unitName: 'Unidad 2', exerciseName: 'Tabla de los Enfermedades' },
      ]
    },
    {
      text: 'Graficas',
      ...
      expanded: false,
      children:[
        {text: 'Grafica Basica', icon:'games', route:'/grafica',description: 'Grafica basica', showDescription: false, showUnitName: false, showExerciseName: false,extraDetails: 'Grafica basica hecha con Amcharts', unitName: 'Unidad 2', exerciseName: 'Grafica con Amcharts'},
        {text: 'Grafica Nueva', icon:'games', route:'/graficaNueva',description: 'Grafica Nueva', showDescription: false, showUnitName: false, showExerciseName: false,extraDetails: 'Grafica Nueva hecha con Amcharts', unitName: 'Unidad 2', exerciseName: 'Grafica con Amcharts'}
